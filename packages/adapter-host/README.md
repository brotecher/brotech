...
The included compatibility matrix is isolated-fixture evidence, not real third-party, production or security validation. Decision 19 assigns Apache-2.0 only to this Mojing-authored artifact and its declared public exports. Its source is published at `https://github.com/brotecher/brotech`; `private: true` continues to prevent unauthorized npm registry publication.
